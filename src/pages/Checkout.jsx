...
const CheckoutPage = () => {
  ...
  const updateAddress = async (email, addressData) => {
    try {
      const response = await fetch(`https://shoesense-backend.vercel.app/updateAddress`, {
        method: 'PUT',
        headers: {
  ...
  const getToken = async () => {
    try {
      const response = await fetch(`https://shoesense-backend.vercel.app/braintree/token`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${auth?.token}`
        }
  ...
  const handlePay = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://shoesense-backend.vercel.app/braintree/payment`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${auth?.token}`
